...
<?php foreach($client->getShows($start, $end, $minrating, $null) as $showinfo){?>
          ...
          for(;$a <= 5; $a = $a + 1) {
              ?><a href="set.php?show=<?php echo $showinfo["URL Name"]; ?>&amp;rating=<?php echo $a; ?>" onclick='return setRating(<?php echo $a; ?>, "<?php echo $showinfo["HTML Name"]; ?>")'><img src="white.png" alt="<?php echo $a;?>"/></a><?php
          } ?></td>
            </tr>
<?php }
} ?>
